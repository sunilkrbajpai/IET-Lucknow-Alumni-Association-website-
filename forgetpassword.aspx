...
<body style="background-color:aquamarine;">
    ...
    <div>
    <h1 style="color:green;text-align:center;font-size:50px;">Password Recovery</h1>
    </div>
</center>
   <a href="login.aspx" ><input id="back" style="color:white;background-color:blueviolet;border-radius:24px;font-size:large;font-weight:bold; width: 50px; height: 40px;" type="button" value="<<" /></a>
    ...
    <center>
        ...
        <tr>
            <td class="auto-style4" style="font-family: Castellar; font-size: large; font-weight: bold; color: #FF66FF">Date Of Birth:-</td>
    <center>
            <td class="auto-style5">
                <asp:TextBox ID="txtdob" placeholder="Date of birth (DD/MM/YYYY)" runat="server" Height="35px" style="text-align: left" Width="350px"></asp:TextBox>
        </td>
            <td class="auto-style6">
...
<asp:ListItem>Your Favourite Movie</asp:ListItem>
    ...
    <center>
            <td class="auto-style3" rowspan="2"> 
             <center>   <asp:Button ID="Button1" class="btn" runat="server" BackColor="DarkGreen" BorderStyle="Outset" Font-Size="Large" Height="54px" Text="Recover Account" Width="300px" OnClick="Button1_Click" ForeColor="White" /></center>
                &nbsp;</td>
