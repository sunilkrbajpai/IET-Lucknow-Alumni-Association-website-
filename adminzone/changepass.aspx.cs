...
public partial class adminzone_changepass : System.Web.UI.Page
{
    ...
    protected void btnchange_Click(object sender, EventArgs e)
    {
        ...
        string cmd = "update adminlogindata set pass='" + enewpass + "' where userid='" + Session["adminid"].ToString() + "' and pass='" + ecurpass + "'";
